# Audit & gel de version — Nova-Fiches 2.2.0.26 (Baseline)
...
## 2) Correctifs integres dans 2.2.0.26
...
- Observations : IDs normalises dans tous les rapports (Station, Ligne de reference, Rapport complet, Leve) pour coherences avec les Residus.
