...
REM ------------------------------------------------------------
REM NOVATLAS - Build installeur Nova-Fiches 2.3.0.98
REM A placer et lancer depuis :
REM C:\Users\micro\Downloads\00 - DEV\Nova-Fiches_2.3.0.98_FIX17_UI_LEVE_XY_DISPLAY
REM ------------------------------------------------------------

set "ROOT_DIR=%~dp0"
set "ROOT_DIR=%ROOT_DIR:~0,-1%"
set "VERSION=2.3.0.98"
...
set "ISS_FILE=%ROOT_DIR%\NovaFiches_2.3.0.98.iss"
